...
class NotesStore extends ChangeNotifier {
  ...
  static const _kNotes = 'notes_v3';
  static const _kGroups = 'groups_v3';
...
class _NotesAppState extends State<NotesApp> {
  ...
  void initState() {
    ...
    NotesStore.instance.addListener(_onChange);
  }

  @override
  void dispose() {
    settings.removeListener(_onChange);
    NotesStore.instance.removeListener(_onChange);
    super.dispose();
  }
